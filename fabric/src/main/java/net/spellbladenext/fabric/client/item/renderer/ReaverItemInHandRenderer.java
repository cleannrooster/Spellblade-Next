...
public class ReaverItemInHandRenderer<T extends Reaver, M extends EntityModel<T> & ArmedModel> extends GeoLayerRenderer<T> {
    private final ItemInHandRenderer itemInHandRenderer;

    public ReaverItemInHandRenderer(IGeoRenderer<T> entityRendererIn, ItemInHandRenderer item) {
