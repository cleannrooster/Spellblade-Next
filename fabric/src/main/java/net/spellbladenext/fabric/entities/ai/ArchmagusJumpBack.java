...
import static net.spellbladenext.fabric.entities.Archmagus.BIDED;
...
public class ArchmagusJumpBack<E extends Archmagus> extends Behavior<E> {
    ...
    protected boolean checkExtraStartConditions(ServerLevel serverLevel, E mob) {
        ...
        if(mob.getEntityData().get(BIDED)){
            health *= 0.5;
        }
        return this.isTargetVisible(mob) && this.isTargetTooClose(mob) && health < mob.damagetakensincelastthink;
    }
