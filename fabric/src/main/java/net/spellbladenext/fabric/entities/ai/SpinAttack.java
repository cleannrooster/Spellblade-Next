...
public class SpinAttack extends Reaver implements InventoryCarrier, IAnimatable {
    ...
    public SpinAttack(Level world, LivingEntity owner) {
        super(SpellbladesFabric.SPIN, world);
        this.getBrain().removeAllBehaviors();
        this.range = 128.0F;
        this.caster = owner;
    }
    ...
    public void tick() {
        ...
        if(tickCount == 5 && this.hero != null){
            ...
            list.forEach(entity -> SpellHelper.performImpacts(this.getLevel(),this.hero,entity,this.spell,this.context));
        }
        if(tickCount == 5 && this.hero == null && this.caster != null){
            ...
            list.forEach(entity -> SpellHelper.performImpacts(this.getLevel(),this.caster,entity,this.spell,this.context));
        }
